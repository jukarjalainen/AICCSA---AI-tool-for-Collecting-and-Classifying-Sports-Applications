...
SPORT TYPE
Use an existing tag when possible; create a concise new one if needed.
Common tags: "football" (soccer), "american_football", "basketball", "baseball", "disc_golf","golf",
"tennis","rugby","cricket","hockey","volleyball","bowling","running","cycling",
"e_biking","endurance_sports","swimming","rowing","hunting","fishing","hunting_fishing",
"shooting_sports","trapping","motorsport","combat_sports","dance","yoga","pilates",
"cheerleading","pickleball","equestrian","esports","team_sports","various","UNKNOWN".
...
- Distinguish "football" (soccer) vs "american_football".
- Use general_health for health & wellness trackers not tied to a specific sport, e.g., sleep, nutrition, hydration, menstrual/cycle, pregnancy/perinatal, mental well-being, generic step/HR dashboards, and perimenopause apps.
...
Common tags: "football" (soccer), "american_football", "basketball", "baseball", "fitness_gym", "golf",
...
- fitness_gym (preferred single tag): Use for exercise/workout content not tied to a specific sport, including home workouts, strength training, HIIT, bodyweight/calisthenics, machine/free-weight instruction, gym chain member apps, general conditioning, and mixed “get fit/lose weight” programs.

Keep general_health for sleep, hydration, nutrition planning, menstrual/cycle, pregnancy/perinatal, stress/mental well-being trackers (no workout catalog focus).

Use specific modality tags when the modality itself is the point: yoga, pilates, dance.
If the app mixes a bit of yoga/pilates inside a broader workout library, prefer fitness_gym.

If training is primarily to improve performance within a specific sport (e.g., “soccer strength plan”), set that sport instead (e.g., football).
